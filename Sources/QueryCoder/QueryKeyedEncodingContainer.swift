...
//
//  QueryKeyedEncodingContainer.swift
//  QueryCoder
//

import Foundation

internal struct QueryKeyedEncodingContainer<K: CodingKey> : KeyedEncodingContainerProtocol {
    typealias Key = K
    ...
    func superEncoder() -> Encoder { return createNestedContainer(for: QueryCodingKey.super) }
